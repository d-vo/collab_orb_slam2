...
LoopClosing::LoopClosing(Map *pMap, KeyFrameDatabase *pDB, ORBVocabulary *pVoc, MapDatabase *pMapDatabase, const bool bFixScale):
    		mbResetRequested(false), mbFinishRequested(false), mbFinished(true), mpMap(pMap), mpTracker(NULL),
...
void LoopClosing::Release()
{
	...
	std::cout << "Loop Closing Release" << std::endl;
}
