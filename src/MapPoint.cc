...
MapPoint::MapPoint(long unsigned int nId, int nRobotId, const cv::Mat &Pos, KeyFrame *pRefKF, Map* pMap):
...
MapPoint::MapPoint(long unsigned int nId, int nRobotId, const cv::Mat &Pos, Map* pMap, Frame* pFrame, const int &idxF):
